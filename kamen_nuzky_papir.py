...
while running:
    ...
    if direction == 0:  # Pohyb vlevo
        new_head = [snake[0][0] - 10, snake[0][1]]
    elif direction == 1:  # Pohyb vpravo
        new_head = [snake[0][0] + 10, snake[0][1]]
    elif direction == 2:  # Pohyb nahoru
        new_head = [snake[0][0], snake[0][1] - 10]
    elif direction == 3:  # Pohyb dolů
        new_head = [snake[0][0], snake[0][1] + 10]
    ...
    if (new_head[0] - x_pos <= 10 and new_head[0] - x_pos >= -10) and (
            new_head[1] - y_pos <= 10 and new_head[1] - x_pos >= -10):
        snake_expend()
        food_event()
    else:
        snake.pop()
